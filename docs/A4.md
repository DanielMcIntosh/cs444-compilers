...
After heirarchy checks have been completed, the next step is to link the remaining Types to their declrations. For NameType AST nodes, this generally follows
